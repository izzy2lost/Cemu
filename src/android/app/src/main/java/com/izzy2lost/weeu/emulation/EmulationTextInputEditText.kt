...
import com.izzy2lost.weeu.nativeinterface.NativeSwkbd
...
fun showEmulationTextInputDialog(
    ...
    val inputEditTextLayout =
        layoutInflater.inflate(
            com.izzy2lost.weeu.R.layout.layout_emulation_input,
            null
        )

    val inputEditText =
        inputEditTextLayout.requireViewById<EmulationTextInputEditText>(com.izzy2lost.weeu.R.id.emulation_input_text)
    ...
    val parentTextInputLayout =
        inputEditTextLayout.requireViewById<TextInputLayout>(com.izzy2lost.weeu.R.id.emulation_input_layout)
